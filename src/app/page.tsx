...
import { Camera, Users, Zap, LogIn, LogOut, Sparkles } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-6">
              ...
              <span className="text-sm font-semibold text-white">AI-Powered Bill Splitting</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              Scan bills with AI, split with friends, pay via UPI. Simple, fast, secure.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link href="/create-bill">
                <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-lg rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-2xl glow">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Camera, title: "AI Scanning", desc: "Instant extraction", color: "from-indigo-500 to-blue-600" },
              { icon: Users, title: "Easy Sharing", desc: "Unlimited friends", color: "from-purple-500 to-pink-600" },
              { icon: Zap, title: "UPI Payments", desc: "Pay instantly", color: "from-amber-500 to-orange-600" },
            ].map((feature, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-4 mx-auto shadow-lg group-hover:scale-110 transition-transform`}>
